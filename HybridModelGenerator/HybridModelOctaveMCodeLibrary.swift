...
class HybridModelOctaveMCodeLibrary: NSObject {
    ...
    static func buildCopyrightHeader(functionName:String, functionDescription:String) -> String {
        ...
        if let local_input_file_url = HybridModelOctaveMCodeLibrary.my_input_url {
...
class KineticsOctaveMStrategy:CodeStrategy {
    ...
    func execute(modelContext:HybridModelContext) -> String {
        ...
        var header_information = HybridModelOctaveMCodeLibrary.buildCopyrightHeader("Kinetics.m",
            functionDescription: "Encodes the metabolic and gene expression kinetics.\n% Called by Balances.m")
...
class ControlOctaveMStrategy:CodeStrategy {
    ...
    func execute(modelContext:HybridModelContext) -> String {
        ...
        var header_information = HybridModelOctaveMCodeLibrary.buildCopyrightHeader("Control.m",
            functionDescription: "Calculates the metabolic and gene expression control vector. Called by Balances.m")
...
class BalanceEquationsOctaveMStrategy:CodeStrategy {
    ...
    func execute(modelContext:HybridModelContext) -> String {
        ...
        // get the copyright header information -
        var header_information = HybridModelOctaveMCodeLibrary.buildCopyrightHeader("Balances.m",
            functionDescription: "Encodes the material balance equations for the metabolic model.\n% Called by SolveBalanceEquations.m")
...
class SolveBalanceEquationsOctaveMStrategy:CodeStrategy {
    ...
    func execute(modelContext:HybridModelContext) -> String {
        ...
        // get the copyright header information -
        var header_information = HybridModelOctaveMCodeLibrary.buildCopyrightHeader("SolveBalanceEquations.m",
            functionDescription: "Solve the balance equations using the LSODE routine.")
...
class DataFileOctaveMStrategy:CodeStrategy {
    ...
    func execute(modelContext:HybridModelContext) -> String {
        ...
        var header_information = HybridModelOctaveMCodeLibrary.buildCopyrightHeader("DataFile.m",
            functionDescription: "Creates a data dictionary holding the initial conditions, and kinetic/control\n% parameters for the metabolic model. Called by SolveBalanceEquations.m")
